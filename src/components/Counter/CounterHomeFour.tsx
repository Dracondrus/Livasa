                    ...
                    <div className="col-lg-12">
                        <div className="tp-counter-4-heading text-center mb-50">
                            ...
                            <p>Online property marketplace to buy, sell, and rent residential and  comme rcial properties. Used by <br />
                                millions of renters to find property. Browse millions of properties in your city save your.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-lg-12">
                        <div className="tp-counter-4-item-box d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
